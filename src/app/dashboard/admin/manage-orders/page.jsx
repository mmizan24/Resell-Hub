    ...
    return (
      <section className="px-5 py-12 md:px-8">
        <div className="max-w-2xl rounded-lg border border-blue-100 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">Please sign in as an admin to manage order records.</p>
          <Link
            href="/auth/sign-in"
    ...
    <main className="mx-auto w-full max-w-7xl space-y-6 px-4 py-8">
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Review checkout activity and adjust payment or order states when needed.
        </p>
      </section>
