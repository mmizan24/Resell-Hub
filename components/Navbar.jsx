                      ...
                      {PROFILE_MENU.map(({ id, label, href, icon }) => (
                        ...
                        >
                          <div className="flex cursor-pointer items-center gap-3 px-4 py-2.5 text-blue-800 transition-colors duration-100 hover:bg-blue-50">
                            ...
                            <Label className="cursor-pointer text-sm font-medium text-blue-800">
                              {label}
                            </Label>
                          </div>
                        </Dropdown.Item>
            ...
            <Dropdown>
              ...
              >
                ...
                <div className="hidden sm:flex flex-col items-start leading-tight">
                  ...
                  <span className="text-blue-200 text-[10px] mt-0.5">
                    My account
                  </span>
                </div>
                <svg
                  className="w-3.5 h-3.5 text-blue-200 ml-0.5"
                  viewBox="0 0 16 16"
                  fill="currentColor"
                >
                  <path d="M4 6l4 4 4-4H4z" />
                  ...
                  <div className="py-1.5">
                    {PROFILE_MENU.map(({ id, label, href, icon }) => (
                      ...
                      >
                        <div className="flex items-center gap-3 px-4 py-2.5 text-blue-800 hover:bg-blue-50 cursor-pointer transition-colors duration-100">
                          ...
                          <Label className="text-sm text-blue-800 font-medium cursor-pointer">
                            {label}
                          </Label>
                        </div>
                      </Dropdown.Item>
                    ...
                    >
                      <div className="flex items-center gap-3 px-4 py-2.5 text-red-600 hover:bg-red-50 cursor-pointer transition-colors duration-100">
                        ...
                        <Label className="text-sm text-red-600 font-medium cursor-pointer">
                          Sign out
                        </Label>
                      </div>
                    </Dropdown.Item>
